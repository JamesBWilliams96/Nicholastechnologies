          ...
          <div className="mt-[1.4cqw] flex gap-[1.6cqw]">
            {swatches.map((s, i) => (
              <span
                key={s.name}
                className={cn(
                  "size-[3.6cqw] rounded-full",
                  s.className,
                  i === 0 ? "ring-2 ring-ink-950 ring-offset-2 ring-offset-white" : "ring-1 ring-ink-950/10",
                )}
              />
            ))}
          </div>
